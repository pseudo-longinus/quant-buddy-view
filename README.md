...
本仓库 `skills/quant-buddy-view/examples/` 放的是离线参考活页，用来演示各类活页长什么样、版式怎么搭。它们是示例与起点，不是模板市场里的官方活页。
...
公共活页和示例只是起点。如果你需要更贴近自己业务的问题、版式或交互，可以让 Agent 定制一张专属活页，再用 quant-buddy-view 发布成同样可分享、会实时更新的链接。进阶做法见 `skills/quant-buddy-view/guides/bespoke-page.md`。
