...
def _capture_exact(cover_html, out_png, *, width=WIDTH, height=HEIGHT, wait_ms=4000):
...
def render_existing_page_thumbnail(params):
    ...
    if not shot:
        return {"code": 1, "source": source, "query": query, "capture": capture, "cover_html": cover_html}
